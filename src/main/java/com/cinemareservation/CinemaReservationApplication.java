...
import com.cinemareservation.move.MovieRepository;
import com.cinemareservation.reservation.Reservation;
import com.cinemareservation.reservation.ReservationRepository;
import com.cinemareservation.room.Room;
import com.cinemareservation.room.RoomRepository;
...
public class CinemaReservationApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Screening s1m1 = Screening.builder().room(r1).movie(m1).startTime(LocalDateTime.now().plusDays(1)).build();
